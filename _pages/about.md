...
5. Wu, X., Lu, J., Wu, S. and Zhou, X.S., 2021. Synchronizing time-dependent transportation services: Reformulation and solution algorithm using quadratic assignment problem. Transportation Research Part B: Methodological, 152, pp.140-179.
...
7. Wu, X., Nie, L. and Xu, M., 2015. Service station evaluation problem in catering service of the high-speed railway: a fuzzy QFD approach based on evidence theory. Mathematical Problems in Engineering, 2015
8. Wu, X., Nie, L., Xu, M. and Fu, H., 2016. Fuzzy QFD for Distribution Center Location Evaluation in Catering Service of High-Speed Railway. Management & Engineering, (22), p.83. 
9. Wang, X., Fu, H., Wu, X., Liu, Y. and Kim, T., 2025. Multilayered Railway Passenger Demand Estimation Considering Nested Choices: A Computational Graph-based Learning Framework. Urban Rail Transit, pp.1-17(corresponding author). 
10. Sun, J., Guo, J., Wu, X., Zhu, Q., Wu, D., Xian, K., and Zhou, X., 2019. Analyzing the impact of traffic congestion mitigation: from an explainable neural network learning framework to marginal effect analyses. Sensors, 19(10), p.2254. (corresponding author). 
11. Simon X.Z., Cheng, Q., Wu, X., Li, P., Belezamo, B., Lu, J. and Abbasi, M., 2022. A meso-to-macro cross-resolution performance approach for connecting polynomial arrival queue model to volume-delay function with inflow demand-to-capacity ratio. Multimodal Transportation, 1(2), p.100017 (corresponding author and 2022 Best Article Award).
